	...
	while 1:
		try:
			...
			if ord(i) in [3,4]:
				...
				break
			ser.write(i)
		except BaseException as taxi cab in the city. Privacy watchdog, the Information Commissioner's Office has said it is "disproportionate" to demand that every Southampton taxi has CCTV that constantly monitors driver and passengers, including recording all conversations."
Read the 98 comments
news privacy uk
35659319 story China
The Nuclear Approach To Climate Change 339
Posted by samzenpus on Thursday July 26, @12:31AM
...
Read the 339 comments
china hardware power
Today
Yesterday
35657107 story Space
Skydiver Leaps From 18 Miles Up In 'Space Jump' Practice 181
Posted by samzenpus on Wednesday July 25, @10:12PM
...
risks usanm newmexico
35655487 story Media
Should Journalists Embrace Jargon? 181
Posted by samzenpus on Wednesday July 25, @08:04PM
...
Read the 181 comments
culture jargon language
35654381 story Businesses
Are Indian High Schoolers Manning Your IBM Help Desk? 226
Posted by samzenpus on Wednesday July 25, @07:24PM
...
Read the 226 comments
ibm helpdesk india
Today Yesterday Tuesday Monday Many More
Follow us: Twitter Facebook RSS Feed
Slashdot Poll
Poll

Malware now infesting my primary computer:
None of which I am aware A few annoyances, but not worth the chase I've got a moderate dose, need to clean it up Klaxons are going off; water is rising Just the OS ...
...
Most Discussed
    ...
    * 743 comments Feds Ban 'Buckyballs' Magnets
    * 698 comments Ask Slashdot: Preempting Sexual Harassment In the Workplace?
    * 642 comments Why Valve Wants To Port Games To Linux: Because Windows 8 Is a Catastrophe
    * 555 comments App Developer: Android Designed For Piracy
    * 549 comments Windows 8 Graphics: Microsoft Has Hardware-Accelerated Everything
...
2010 	Louisiana, Intelligent Design, and Science Classes 	989 comments
2009 	26 Years Old and Can't Write In Cursive 	921 comments
2007 	What's Keeping US Phones In the Stone Age? 	925 comments
2005 	USA to Pass Science Crown to China 	1247 comments
2004 	Reading Slashdot From Strange Locations 	1006 comments
Freecode.com releases

    * JAXX 2.5.1
    * TaskJuggler 3.3.0
    * Tine 2.0 Joey (2012/10) Alpha 1
    * Apache OpenMeetings 2.0 Incubating
    * Vortex Library 1.1.12
    * ERDtext 1.1
    * MacPorts 2.1.2
    * ERDialog Web Framework 2.14
